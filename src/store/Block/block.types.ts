...
export enum BLOCK_TYPES  {
    ...
    SET_BLOCK_ROOM_OPTION = 'block/SET_BLOCK_ROOM_OPTION',
    SET_BLOCK_TYPE_OPTION = 'block/SET_BLOCK_TYPE_OPTION',
    FETCH_BLOCK_TOTALS_START = 'block/FETCH_BLOCK_TOTALS_START',
    FETCH_BLOCK_TOTALS_SUCCESS = 'block/FETCH_BLOCK_TOTALS_SUCCESS',
    FETCH_BLOCK_TOTALS_FAILED = 'block/FETCH_BLOCK_TOTALS_FAILED'
}
